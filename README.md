...
**описание добавлено в readme таска 3**: логика ESB не переезжает в одно новое место — она намеренно расщепляется. Принцип называется «умные сервисы, простая шина»
